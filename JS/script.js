...
let div = document.querySelector(".stopwatch-display");
...
const count = () => {
    ...
    display.lastElementChild.innerText = getTwoDigits(s); 
    display.firstElementChild.nextElementSibling.innerText =  getTwoDigits(m);
    display.firstElementChild.innerText =  getTwoDigits(h);
